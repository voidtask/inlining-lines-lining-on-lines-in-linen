 ...
 *
 * Modified by Troshkina Anna 2015
    ...
    Form.Field = Backbone.View.extend({
        ...
        createEditor: function() {
            var options = _.extend(
                _.pick(this, 'schema', 'form', 'key', 'model', 'value', 'el'),
        ...
        setError: function(msg) {
            ...
            if (this.$el.closest('#' + $(mg_echo_global.formStep2.getForm().el).attr('id')).length > 0) {
                mg_echo_global.formStep2.getForm().showError(msg, 'heap');
            } else {
                mg_echo_global.formStep1.getForm().showError(msg, 'heap');
            }
        },
        ...
        validate: function() {
            ...
            if (validators) {
                ...
                _.every(validators, function(validator) {
                    error = getValidator(validator)(value, formValues, that);
        ...
        setOptions: function(options) {
            ...
            if (options instanceof Backbone.Collection) {
                ...
                if (collection.length > 0) {
                    ...
                    if(self.schema.fetchConfig) {
                        Backbone.$.extend(fetchConfig, self.schema.fetchConfig);
                    }
  ...
  ', null, Form.templateSettings)
    ...
    Form.editors.Object = Form.editors.Base.extend({
        ...
        initialize: function(options) {
            ...
            if(options.el) {
                //we do not need to render html, render will not be invoked
                //Get the constructor for creating the nested form; i.e. the same constructor as used by the parent form
                var NestedForm = this.schema.constructor || this.form.constructor;
        ...
        setValue: function(value) {
            this.value = value;
             ...
             if(!this.el) {
                 //we do not need to render html, render will not be invoked
                 this.render();
             } else if (this.nestedForm) {
                 this.nestedForm.setValue(value);
             }
        },
    ...
    Form.editors.NestedModel = Form.editors.Object.extend({
        ...
        commit: function() {
            ...
            if (error) {
                this.$el.addClass('mg-echo-error');
                return error;
            }
