 ...
 * Modified by Evgeny Kalibrov, 2016 !!!!!!!
 *
 * Modified by Valentin Starobinets:
 * - fixed proper event subscription to window.load when upgraded to jQuery 3.5.1
 */
...
(function(factory) {
    ...
    Plugin.prototype = {
        ...
        _showDropdown: function() {
            ...
            this.telInput.closest('.field-container-wrapper').addClass('mg-echo-focus');
        },
        ...
        _closeDropdown: function(e) {
            ...
            if (e == null || e.target !== this.telInput[0]) {
                this.telInput.closest('.field-container-wrapper').removeClass('mg-echo-focus');
            }
        },
    ...
    var allCodes = allCountries.map(function(i){
        return "+" + i[2];
    });
